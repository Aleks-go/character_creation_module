...
def attack(char_name: str, char_class: str) -> str:
    """Определение наносимого урона."""
    if char_class == 'warrior':
        return (
            f'{char_name} нанёс уронпротивнику равный {5 + randint(3, 5)}')
    if char_class == 'mage':
        return (
    ...
    if char_class == 'healer':
        ...
        return (f'{char_name} нанес урон равный 5')
...
def special(char_name: str, char_class: str) -> str:
    """Определение значений специальных умений."""
    if char_class == 'warrior':
        return (
